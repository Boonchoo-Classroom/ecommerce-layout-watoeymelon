...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recommendedProducts.add(ProductModel("Puma Speedcat (Red)", "รองเท้าที่เหมาะทั้งผู้หญิงและผู้ชาย", 3800.00, R.drawable.a))
        recommendedProducts.add(ProductModel("Puma Speedcat (Brown)", "รองเท้าที่เหมาะทั้งผู้หญิงและผู้ชาย", 3800.00, R.drawable.b))
        recommendedProducts.add(ProductModel("Puma Palermo", "รองเท้าสุดคลาสสิค", 3500.00, R.drawable.c))
        ...
        promotionsList.add(ProductModel("PUMA x MIRACULOUS Set Kids ", "เสื้อPuma + กางเกงPuma (Kids)", 2000.00, R.drawable.bundle_a))
